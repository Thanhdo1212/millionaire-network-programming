	...
	do{
		...
		switch(op){
			...
			case 2:
				...
				printf("3. Nhập A, B, C, D để chọn đáp án đúng; H để sử dụng trợ giúp 50/50; S để dừng cuộc chơi.\n");
				printf("4. Online được sử dụng trợ giúp tối đa 3 lần, offline không giới hạn.\n");	
			break;
			case 3:
				printf("\n********* Credit *********\n");
				printf("1. Đỗ Đức Thành\n");
				printf("2. Hà Nhật Quang\n");
				printf("3. Nguyễn Doãn Tuấn\n");
			break;
			default: break;
		}
	} while (op != 4);
